...
class DashboardManager {
    ...
    async loadDashboards() {
        try {
            console.log('Cargando dashboards desde:', `${API_BASE}dashboards`);
            ...
            console.log('URL de la API:', `${API_BASE}dashboards`);
    ...
    async updateDashboard(event) {
        ...
        try {
            const response = await fetch(`${API_BASE}dashboard/update`, {
                method: 'POST',
                body: formData
            });
    ...
    async viewDashboard(slug) {
        window.location.href = `/Hackdash-aiweekend/frontend/dashboard?slug=${slug}`;
    }
    ...
    async editDashboard(slug) {
        try {
            ...
            const response = await fetch(`${API_BASE}dashboard/get?slug=${slug}&edit=true`);
            const result = await response.json();
    ...
    async deleteDashboard(slug, title) {
        ...
        try {
            ...
            const response = await fetch(`${API_BASE}dashboard/delete`, {
                method: 'POST',
                body: formData
            });
