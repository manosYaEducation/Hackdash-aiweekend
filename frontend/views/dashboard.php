...
<body>
  ...
  <div class="dashboard-header">
    <div class="header-content">
      ...
      <div class="dashboard-actions">
        <button class="btn btn-secondary" onclick="showCreateProjectMemberModal()">
  ...
  <div id="createMemberModal" class="modal" style="display: none;">
    <div class="modal-content">
      ...
      <form id="memberForm">
        <div class="form-group">
          ...
          <label for="name">Nombre Weekener</label>
          <input type="text" id="name" name="name" placeholder="Weekener Soñado" required>
        </div>
    
        <div class="modal-buttons">
          <button type="button" class="btn btn-secondary" onclick="hidecreateMemberModal()">Cancelar</button>
          <button type="submit" class="btn btn-primary">Invitar Miembro</button>
