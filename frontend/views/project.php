...
<body>
  ...
  <div class="project-header">
    <div class="header-content">
      ...
      <div class="project-actions">
        <span class="status-badge status-active" id="projectStatus">Integración</span>
  ...
  <div class="project-container">
    ...
    <!-- Tabs -->
    <div class="tabs">
      <div class="tab " onclick="showTab('tasks')">Tareas</div>
      <!-- <div class="tab" onclick="showTab('files')">Archivos</div> -->
      <div class="tab active" onclick="showTab('members')">Miembros</div>
  ...
  <div id="createMemberModal" class="modal">
    <div class="modal-content">
      ...
      <form id="taskForm">
        ...
        <div class="modal-buttons">
          <button type="button" class="btn-cancel" onclick="hidecreateMemberModal()">Cancelar</button>
          <button type="submit" class="btn-submit">Invitar Miembro</button>
        </div>
      </form>
    </div>
  </div>
